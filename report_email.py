...
if __name__ == "__main__":
    user = os.getenv('USER')
    description_directory = '/home/student-03-71c9698042db/supplier-data/descriptions/'.format(user)  # The directory which contains all the files with data in it.
    ...
    msg = generate_email("automation@example.com", "student-03-71c9698042db@example.com".format(user),
